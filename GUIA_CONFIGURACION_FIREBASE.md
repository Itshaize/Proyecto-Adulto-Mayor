...
El firmware no genera valores aleatorios. Si la señal no permite calcular BPM y SpO₂ válidos, emite un error y no crea una medición. El pulsador sí crea una alerta crítica aun sin signos vitales.
