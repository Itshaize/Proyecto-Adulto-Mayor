...
export class HistorialAdminComponent implements OnInit {
  private readonly tomaService=inject(TomaService);private readonly medicionService=inject(MedicionService);tab:'medicacion'|'salud'='medicacion';tomas:Toma[]=[];mediciones:Medicion[]=[];loading=true;error='';desde='';hasta='';estado='TODOS';medicamento='TODOS';tipo='TODOS';showFilters=false;
