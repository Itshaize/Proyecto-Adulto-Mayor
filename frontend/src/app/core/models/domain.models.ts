...
export interface Paciente { _id: string; nombre: string; edad: number; fechaNacimiento: string; diagnosticos: string[]; telefonoContacto: string; hijoAdminId: string; usuarioAdultoId: string; dispositivoId: string; activo: boolean; }
...
export interface Dispositivo { _id: string; dispositivoId: string; pacienteId: string; estado: EstadoDispositivo; ultimaConexion: string; versionFirmware: string; }
